    ...
    <main className="bg-surface min-h-screen pt-24 md:pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mb-16 animate-slide-up">
          ...
          <h1 className="font-headline font-black text-4xl md:text-5xl text-on-surface uppercase tracking-tight">Preferencias de Socio</h1>
        </header>
        ...
        <section className="bg-white p-8 md:p-12 border border-[#f1f1ec] shadow-[0_40px_80px_-20px_rgba(45,47,44,0.1)] mb-12 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <div className="flex items-start gap-6 mb-8">
            ...
            <div>
              <h3 className="font-headline font-bold text-xl text-on-surface uppercase tracking-tight mb-2">Recepción de Comisiones</h3>
              <p className="font-label text-xs uppercase tracking-widest text-on-surface-variant opacity-60 leading-relaxed max-w-lg">
                Conecta tu cuenta de Mercado Pago para recibir tus comisiones automáticamente al instante en que se realice una venta a través de tu link.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white p-8 md:p-12 border border-[#f1f1ec] animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <h3 className="font-headline font-bold text-xl text-on-surface uppercase tracking-tight mb-8">Datos Personales</h3>
